...
export default function Input({
  ...
  const BuildInput = BuildComponent({
    name: "Input",
    defaultClasses:
      "outline-none focus:outline-2 focus:outline-blue-500/50 w-full h-full px-2 border-[1px] border-neutral-200 dark:border-dark-border dark:bg-dark placeholder:text-dark-accent placeholder:text-sm",
