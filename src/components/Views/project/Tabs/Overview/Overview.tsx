...
export default function Overview() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 py-2 pt-2 items-start">
      <div className="border-[1px] order-last sm:order-first border-neutral-200 dark:border-dark-border rounded-lg items-start flex flex-col">
        <div className="border-b-[1px] border-neutral-200 dark:border-dark-border w-full">
          <div className="flex flex-row gap-2 items-center p-4 text-lg font-semibold border-b-[1px] border-neutral-200 dark:border-dark-border">
            <IoFlagOutline />
            <span className="dark:text-dark-text">Project Score</span>
          </div>
          <div className="p-4 flex flex-col items-center gap-2 relative">
            <View.If visible={isProjectNew}>
              <div className="backdrop-blur-sm bg-white/50 dark:bg-dark/60 inset-0 absolute z-50 flex justify-center items-center">
        ...
        <div className="flex flex-col w-full h-full">
          <div className="flex flex-row justify-between gap-2 items-center p-4 text-lg font-semibold border-b-[1px] border-neutral-200 dark:border-dark-border">
            <div className="flex flex-row gap-2 items-center dark:text-dark-text">
              <HiOutlineDocument />
              <span>Pages</span>
            </div>
            {/*<Link href={`/Views/project/${id}?page=pages`}>
              <Button
          ...
          <div className="flex flex-col gap-2 p-4 border-b-[1px] border-neutral-200 dark:border-dark-border">
            <Pages />
          </div>
        </div>
        <div className="flex flex-col w-full h-full">
          <div className="flex flex-row justify-between gap-2 items-center p-4 text-lg font-semibold border-b-[1px] border-neutral-200 dark:border-dark-border">
            <div className="flex flex-row gap-2 items-center">
              ...
              <span className="dark:text-dark-text">Statistics</span>
            </div>
          </div>
      ...
      <div className="flex flex-col rounded-lg border-[1px] border-neutral-200 dark:border-dark-border">
        <div className="flex flex-row h-[61px] justify-between p-4 text-lg font-semibold border-b-[1px] border-neutral-200 dark:border-dark-border">
          <div className="flex flex-row gap-2 items-center">
            <MdAccessTime />
            <span className="dark:text-dark-text">Last exceptions</span>
          </div>
