    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 pt-2 gap-2 sm:gap-4">
      <div className="flex flex-col gap-2 items-start">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="text-neutral-500 dark:text-dark-accent text-sm">
            This domain should match where you are using Nexys Client Library.
          </div>
        </div>
        <div className="flex flex-col w-full dark:text-dark-text">
          <div className="flex flex-row gap-2 items-start">
            <span>Project Creation</span>
            <time
              dateTime={project?.createdAt?.toString()}
              className="dark:text-dark-accent text-neutral-400"
            >
              {formatDateToHuman({
          ...
          <div className="flex flex-row gap-2 items-start">
            ...
            <span className="dark:text-dark-accent text-neutral-400">
