...
export default function Settings() {
  ...
  return (
    <div className="grid gap-2 py-2 pt-2 items-start max-w-full">
      <div className="border-[1px] sm:order-first min-w-full order-last border-neutral-200 dark:border-dark-border rounded-lg items-start flex flex-col">
        <div className="flex flex-row gap-2 w-full items-center p-4 text-lg font-semibold border-b-[1px] border-neutral-200 dark:border-dark-border">
          <IoMdSettings />
