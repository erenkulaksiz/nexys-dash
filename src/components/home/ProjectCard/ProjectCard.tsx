...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <div className="relative group flex flex-col gap-2 dark:bg-black bg-white rounded-lg p-4 h-32 cursor-pointer border-[1px] border-neutral-200 dark:border-neutral-900 hover:dark:border-neutral-300 hover:border-neutral-400">
