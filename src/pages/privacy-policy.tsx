...
export default function PrivacyPolicyPage(props: NexysComponentProps) {
  return (
    <Layout {...props}>
      <Head>
        ...
        <div className="grid grid-cols-1 gap-4 mt-4 text-neutral-700 dark:text-neutral-300">
          ...
          <div>
            ...
            <ul className="list-disc mt-4 grid grid-cols-1 gap-4 text-sm pl-4">
              ...
              <li>
                Website refers to Nexys, accessible from{" "}
                <a href="https://nexys.app" className="text-blue-600">
                  https://nexys.app
                </a>
              </li>
              <li>
